...
System.register("chunks:///_virtual/T1PaintBuildProof.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _inheritsLoose, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, screen, Vec3, view, ResolutionPolicy, AudioSource, Node, Layers, UITransform, Canvas, Camera, Color, Button, UIOpacity, Graphics, Label, Sprite, resources, SpriteFrame, AudioClip, Tween, tween, HorizontalTextAlignment, VerticalTextAlignment, Component;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
      _asyncToGenerator = module.asyncToGenerator;
      ...
      var T1PaintBuildProof = exports('T1PaintBuildProof', (_dec = ccclass('T1PaintBuildProof'), _dec(_class = /*#__PURE__*/function (_Component) {
        ...
        _proto.loadFinalAnimal = function loadFinalAnimal() {
          ...
          Promise.all(frameNames.map(function (name) {
            ...
            _this7.showStatus('点击下方队首颜色车', 4.2);
            _this7.setAutomationStatus('ready');
            _this7.updateControlButtons();
          })["catch"](function (error) {
            _this7.showStatus('兔兔没有准备好，请重新加载', 0);
        ...
        _proto.showStatus = function showStatus(message, duration) {
          ...
          this.scheduleOnce(function () {
            if (epoch !== _this9.statusEpoch || !_this9.statusToast.active) return;
            tween(_this9.statusToastOpacity).to(0.2, {
              opacity: 0
            }, {
              easing: 'quadOut'
            }).call(function () {
              if (epoch === _this9.statusEpoch) _this9.statusToast.active = false;
            }).start();
          }, duration);
        };
              ...
              while (1) switch (_context2.prev = _context2.next) {
                ...
                case 14:
                  ...
                  walking = jobs.map(function (job, index) {
                    return _this10.walkShellBlockToCar(job.tray, job.cell, index * 0.014, index % 4 === 0);
                  });
                ...
                case 25:
                  ...
                  workingTrays.forEach(function (_, index) {
                    return _this10.playSound('land', index === 0 ? 0.22 : 0.16);
                  });
                  this.updateSlotLabels();
                  _context2.next = 30;
                ...
                case 32:
                  ...
                  return Promise.all(workingTrays.filter(function (tray) {
                    ...
                    return _this10.releaseTray(tray);
                  }));
                case 34:
                  _context2.next = 36;
                ...
                case 54:
                  neededNames = Array.from(new Set(this.getExposedCells().map(function (cell) {
                    return _this10.getDefinition(cell.paintId).name;
                  })));
                  hasQueueChoice = this.trays.some(function (tray) {
                    return _this10.isQueueFront(tray);
                  });
              ...
              while (1) switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  return _context3.abrupt("return", new Promise(function (resolve) {
                    var definition = _this11.getDefinition(target.paintId);
                    var walker = _this11.createSoftSquare(_this11.canvasNode, 'WalkingShellBlock', target.position.x, target.position.y, _this11.blockVisualSize * 0.74, definition.color, definition.deep);
                    _this11.addWalkingLegs(walker, definition.deep);
                    _this11.transientNodes.push(walker);
                    var start = target.position.clone();
                    var carDoor = new Vec3(tray.node.position.x, tray.node.position.y + 6, 0);
                    var route = _this11.getWalkingRoute(target, tray);
                    var previous = start;
                    ...
                    motion.to(0.12, {
                      ...
                      if (showLandingEffect) _this11.createLandingRipple(tray.node.position, tray.definition.color);
                      walker.destroy();
                      _this11.transientNodes = _this11.transientNodes.filter(function (node) {
                        return node !== walker;
                      });
                      resolve();
                    }).start();
        ...
        _proto.getWalkingRoute = function getWalkingRoute(target, tray) {
          ...
          var toPosition = function toPosition(_ref3) {
            var column = _ref3[0],
              row = _ref3[1];
            return new Vec3(column * _this12.boardPitch, _this12.boardBaseY + (row - _this12.boardMinRow) * _this12.boardPitch, 0);
          };
              ...
              while (1) switch (_context5.prev = _context5.next) {
                ...
                case 2:
                  ...
                  tween(this.finalAnimal).to(0.12, {
                    ...
                    _this13.finalAnimalSprite.spriteFrame = _this13.finalAnimalFrames.joy;
                    _this13.playSound('success', 0.68);
                    _this13.playHaptic([16, 40, 22]);
                  }).to(0.18, {
                    ...
                    _this13.finalAnimalSprite.spriteFrame = _this13.finalAnimalFrames.blink;
                ...
                case 16:
                  ...
                  this.showResult('success', '兔兔获救！', '下一位小伙伴听见啦');
                  this.setAutomationStatus('passed');
                  this.updateControlButtons();
                case 21:
                case "end":
                ...
                case 2:
                  ...
                  this.activeSlots.forEach(function (tray) {
                    ...
                    tween(tray.node).to(0.08, {
                      ...
                      position: _this14.slotPositions[tray.slotIndex]
                    }).start();
                  });
                  _context6.next = 12;
        ...
        _proto.updateSlotLabels = function updateSlotLabels() {
          ...
          this.slotLabels.forEach(function (label, index) {
            var tray = _this15.activeSlots[index];
            label.string = '';
            var slotGraphics = _this15.slotNodes[index].getComponent(Graphics);
            _this15.drawOutlinedPanel(slotGraphics, 58, 66, 15, tray ? new Color(tray.definition.color.r, tray.definition.color.g, tray.definition.color.b, 52) : new Color(115, 109, 145, 70), tray ? new Color(255, 255, 255, 205) : new Color(238, 237, 248, 175), 2, !tray);
        ...
        _proto.allocateExposedJobs = function allocateExposedJobs() {
          ...
          this.getExposedCells().forEach(function (cell) {
            ...
            var candidates = _this16.activeSlots.filter(function (tray) {
              var _assigned$get;
        ...
        _proto.createCelebration = function createCelebration() {
          ...
          var _loop6 = function _loop6() {
            ...
            _this17.canvasNode.addChild(ring);
            ...
            _this17.transientNodes.push(ring);
          ...
          var _loop7 = function _loop7() {
            ...
            var spark = _this17.createSoftSquare(_this17.canvasNode, "PaintSpark" + index, 0, burstY, 8 + index % 3 * 2, colors[index % colors.length], colors[index % colors.length]);
              ...
              while (1) switch (_context7.prev = _context7.next) {
                case 0:
                  ...
                  sampleJobs.forEach(function (job, index) {
                    var definition = _this18.getDefinition(job.cell.paintId);
                    var spark = _this18.createSoftSquare(_this18.canvasNode, "PathSpark:" + index, job.cell.position.x, job.cell.position.y, 6, definition.color, definition.deep);
                    _this18.transientNodes.push(spark);
                    tween(spark).by(0.28, {
        ...
        _proto.createCarExhaust = function createCarExhaust(position, color) {
          ...
          var _loop8 = function _loop8() {
            ...
            _this19.canvasNode.addChild(puff);
            ...
            _this19.transientNodes.push(puff);
        ...
        _proto.createLandingRipple = function createLandingRipple(position, color) {
          ...
          tween(opacity).to(0.2, {
            ...
            ripple.destroy();
            _this20.transientNodes = _this20.transientNodes.filter(function (node) {
              return node !== ripple;
            });
          }).start();
        };
        ...
        _proto.undoLastMove = function undoLastMove() {
          ...
          this.trays.forEach(function (tray, index) {
            ...
            if (tray.slotIndex >= 0 && tray.remaining > 0) {
              tray.node.active = true;
              tray.node.setPosition(_this21.slotPositions[tray.slotIndex]);
              tray.node.setScale(0.92, 0.92, 1);
              tray.button.interactable = false;
              _this21.activeSlots[tray.slotIndex] = tray;
        ...
        _proto.showResult = function showResult(kind, title, detail) {
          ...
          if (kind === 'success') {
            this.resultPrimaryLabel.string = '下一只动物';
            ...
            this.resultPrimaryLabel.string = '再救一次';
        ...
        _proto.handleResultPrimary = function handleResultPrimary() {
          if (this.resultMode === 'success') {
            this.showResult('next-preview', '下一只动物', '新伙伴将在后续关卡加入');
            if (typeof document !== 'undefined') document.documentElement.dataset.nextAnimalRequested = 'true';
            return;
          }
          ...
          if (this.resultMode === 'next-preview') {
            this.resetSample();
            this.playSound('select', 0.34);
          }
        };
        ...
        _proto.updateControlButtons = function updateControlButtons() {
          ...
          this.trays.forEach(function (tray) {
            tray.button.interactable = Boolean(_this22.finalAnimal && !_this22.gamePaused && !overlayOpen && !_this22.terminal && _this22.activeSlots.some(function (active) {
              return active === null;
            }) && _this22.isQueueFront(tray));
          });
          this.updateAutomationMetrics();
        };
        _proto.updateAutomationMetrics = function updateAutomationMetrics() {
          ...
          document.documentElement.dataset.availablePaintBoxes = String(this.trays.filter(function (tray) {
            return _this23.isQueueFront(tray);
          }).length);
        ...
        _proto.wait = function wait(seconds) {
          var _this24 = this;
          return new Promise(function (resolve) {
            return _this24.scheduleOnce(resolve, seconds);
          });
        };
        _proto.setAutomationStatus = function setAutomationStatus(status) {
          if (typeof document !== 'undefined') {
            ...
            document.documentElement.dataset.uiVersion = 'rescue-loop-hud-v9';
            ...
            document.documentElement.dataset.resultFlow = 'success-next-animal-fail-undo-restart';
