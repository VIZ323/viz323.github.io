...
System.register("chunks:///_virtual/T1PaintBuildProof.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _inheritsLoose, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, screen, Vec3, view, ResolutionPolicy, AudioSource, Node, Layers, UITransform, Canvas, Camera, Color, Button, Graphics, UIOpacity, Label, Sprite, resources, SpriteFrame, AudioClip, Tween, tween, HorizontalTextAlignment, VerticalTextAlignment, Component;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
      _asyncToGenerator = module.asyncToGenerator;
      ...
      var T1PaintBuildProof = exports('T1PaintBuildProof', (_dec = ccclass('T1PaintBuildProof'), _dec(_class = /*#__PURE__*/function (_Component) {
        ...
        function T1PaintBuildProof() {
          ...
          _this.paintDefinitions = [{
            ...
            name: '奶油杏',
            shortName: '奶杏',
            color: new Color(242, 185, 105, 255),
            deep: new Color(171, 105, 50, 255),
            total: 0
          }, {
            id: 'ivory',
            name: '暖绒白',
            shortName: '暖白',
            color: new Color(255, 237, 177, 255),
            deep: new Color(190, 142, 65, 255),
            total: 0
          }, {
            id: 'oat',
            name: '燕麦棕',
            shortName: '燕麦',
            color: new Color(202, 139, 82, 255),
            deep: new Color(127, 75, 43, 255),
            total: 0
          }, {
            id: 'cocoa',
            name: '可可棕',
            shortName: '可可',
            color: new Color(126, 75, 63, 255),
            deep: new Color(67, 39, 36, 255),
            total: 0
          }, {
            id: 'blush',
            name: '耳朵粉',
            shortName: '耳粉',
            color: new Color(240, 126, 146, 255),
            deep: new Color(170, 68, 91, 255),
            total: 0
          }];
        ...
        _proto.createLayout = function createLayout() {
          ...
          this.addLabel(levelPill, '关卡 12', 0, 0, 14, Color.WHITE, 70, true);
          var settingsControl = this.createControlButton('SettingsButton', '设', -154, y(382, 307));
          settingsControl.button.interactable = false;
          settingsControl.opacity.opacity = 255;
          var undoControl = this.createControlButton('UndoButton', '撤', 118, y(382, 307));
          ...
          var restartControl = this.createControlButton('RestartButton', '重', 163, y(382, 307));
          ...
          this.resultBanner = this.addPanel(this.canvasNode, 'ResultBanner', 0, y(42, 30), 292, 72, 22, new Color(255, 252, 247, 250));
          this.resultTitle = this.addLabel(this.resultBanner, '完成！', 0, 12, 18, new Color(70, 60, 105, 255), 250, true);
          this.resultDetail = this.addLabel(this.resultBanner, '兔兔完成', 0, -14, 11, new Color(119, 111, 143, 255), 250);
        ...
        _proto.createTileBackdrop = function createTileBackdrop(parent, width, height) {
          ...
          node.addComponent(UITransform).setContentSize(width, height);
          var graphics = node.addComponent(Graphics);
          // 背景不再使用与目标相同的像素块语言，避免玩家把装饰误认为待拼区域。
        ...
        _proto.createBlueprint = function createBlueprint() {
          ...
          layout.forEach(function (entry, index) {
            ...
            var ghost = _this4.createTargetSquare(_this4.blockAnimal, "GhostCell" + index, position.x, position.y, blockSize, definition.color, definition.deep);
        ...
        _proto.createPaintTrays = function createPaintTrays() {
          ...
          this.paintBatchPlans.forEach(function (plan, index) {
            var definition = _this5.getDefinition(plan.paintId);
            var home = _this5.getQueuePosition(plan.columnIndex, plan.depthIndex);
            var node = _this5.createPaintTrayNode(definition, home, plan.amount, index);
        ...
        _proto.refreshQueueTrays = function refreshQueueTrays(animated) {
          ...
          var _loop = function _loop(columnIndex) {
            ...
            pending.forEach(function (tray, queueRank) {
              var home = _this6.getQueuePosition(columnIndex, queueRank);
        ...
        _proto.loadFinalAnimal = function loadFinalAnimal() {
          ...
          Promise.all(frameNames.map(function (name) {
            return _this7.loadSequenceFrame(name);
          })).then(function (frames) {
            var frameByName = new Map(frameNames.map(function (name, index) {
              return [name, frames[index]];
            }));
            _this7.finalAnimalFrames = {
              normal: frameByName.get('normal'),
              blink: frameByName.get('blink'),
              joy: frameByName.get('joy')
            };
            var animalWidth = _this7.compactLayout ? 170 : 205;
            var animalHeight = _this7.compactLayout ? 255 : 308;
            var animalY = _this7.compactLayout ? 112 : 145;
            _this7.guideAnimal = new Node('BackgroundBunnyGuide');
            _this7.guideAnimal.layer = Layers.Enum.UI_2D;
            _this7.guideAnimal.setPosition(0, animalY, 0);
            _this7.guideAnimal.addComponent(UITransform).setContentSize(animalWidth, animalHeight);
            _this7.canvasNode.addChild(_this7.guideAnimal);
            var guideSprite = _this7.guideAnimal.addComponent(Sprite);
            guideSprite.sizeMode = Sprite.SizeMode.CUSTOM;
            guideSprite.spriteFrame = _this7.finalAnimalFrames.normal;
            guideSprite.color = new Color(235, 220, 207, 255);
            _this7.guideAnimalOpacity = _this7.guideAnimal.addComponent(UIOpacity);
            _this7.guideAnimalOpacity.opacity = 0;
            _this7.guideAnimal.setSiblingIndex(_this7.blockAnimal.getSiblingIndex());
            _this7.finalAnimal = new Node('FullFrameCuteBunny');
            _this7.finalAnimal.layer = Layers.Enum.UI_2D;
            _this7.finalAnimal.setPosition(0, animalY, 0);
            _this7.finalAnimal.addComponent(UITransform).setContentSize(animalWidth, animalHeight);
            _this7.canvasNode.addChild(_this7.finalAnimal);
            _this7.finalAnimalSprite = _this7.finalAnimal.addComponent(Sprite);
            _this7.finalAnimalSprite.sizeMode = Sprite.SizeMode.CUSTOM;
            _this7.finalAnimalSprite.spriteFrame = _this7.finalAnimalFrames.normal;
            _this7.finalAnimalOpacity = _this7.finalAnimal.addComponent(UIOpacity);
            _this7.finalAnimalOpacity.opacity = 0;
            _this7.finalAnimal.active = false;
            _this7.status.string = '选择颜料罐，方块会自动寻找当前可拼的同色位置';
            _this7.setAutomationStatus('ready');
            _this7.updateControlButtons();
          })["catch"](function (error) {
            _this7.status.string = '整帧动画资产加载失败';
            _this7.setAutomationStatus('asset-error');
            console.error('[T1-PaintBuild] Failed to load full-frame bunny sequence', error);
          });
        };
        _proto.loadSequenceFrame = function loadSequenceFrame(name) {
          return new Promise(function (resolve, reject) {
            resources.load("characters/bunny-2d-sequence-v1/" + name + "/spriteFrame", SpriteFrame, function (error, frame) {
              if (error || !frame) {
                reject(error != null ? error : new Error("Missing full-frame sequence asset: " + name));
                return;
              }
              resolve(frame);
            });
        ...
        _proto.loadAudio = function loadAudio() {
          ...
          soundIds.forEach(function (soundId) {
            resources.load("audio/vertical-slice/" + soundId, AudioClip, function (error, clip) {
              ...
              _this8.audioClips.set(soundId, clip);
            });
          });
        };
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                ...
                case 5:
                  ...
                  this.updateControlButtons();
                  this.setAutomationStatus('running');
                  this.status.string = tray.definition.name + "\u8FDB\u5165\u989C\u6599\u4F4D\uFF0C\u81EA\u52A8\u5BFB\u627E\u540C\u8272\u65B9\u5757\u2026";
                    ...
                    return _regeneratorRuntime().wrap(function _loop2$(_context2) {
                      while (1) switch (_context2.prev = _context2.next) {
                        ...
                        case 9:
                          ...
                          _this9.status.string = workingTrays.length > 1 ? workingNames + "\u540C\u65F6\u62FC\u7B2C " + (row + 1) + " \u5C42" : workingNames + "\u81EA\u52A8\u62FC\u5230\u7B2C " + (row + 1) + " \u5C42";
                          _context2.next = 16;
                        ...
                        case 16:
                          jobs.forEach(function (_ref, index) {
                            var cell = _ref.cell,
                              tray = _ref.tray;
                            cell.completed = true;
                            cell.fill.active = true;
                            cell.fill.setScale(0.32, 0.32, 1);
                            tween(cell.fill).delay(index * 0.008).to(0.14, {
                              scale: Vec3.ONE
                            }, {
                              easing: 'backOut'
                            }).start();
            ...
            return _regeneratorRuntime().wrap(function _callee5$(_context6) {
              while (1) switch (_context6.prev = _context6.next) {
                ...
                case 2:
                  ...
                  this.status.string = '拼完了！方块正在变成完整的小动物动画…';
                  this.updateControlButtons();
                  Tween.stopAllByTarget(this.blockAnimal);
                  tween(this.blockAnimal).to(0.2, {
                    scale: new Vec3(1.08, 0.94, 1)
                  }, {
                    easing: 'quadOut'
                  }).to(0.24, {
                    scale: new Vec3(0.78, 1.12, 1)
                  }, {
                    easing: 'quadInOut'
                  }).to(0.32, {
                  ...
                  tween(this.blockAnimal.getComponent(UIOpacity)).delay(0.28).to(0.38, {
                    opacity: 0
                  }).start();
                  Tween.stopAllByTarget(this.guideAnimalOpacity);
                  tween(this.guideAnimalOpacity).delay(0.22).to(0.36, {
                    opacity: 0
                  }).start();
                  this.resetSequencePose();
                  this.finalAnimal.active = true;
                  this.finalAnimal.setScale(0.64, 0.64, 1);
                  this.finalAnimalOpacity.opacity = 0;
                  tween(this.finalAnimalOpacity).delay(0.34).to(0.28, {
                    opacity: 255
                  }).start();
                  tween(this.finalAnimal).delay(0.34).to(0.34, {
                    scale: new Vec3(1.06, 0.94, 1)
                  }, {
                    easing: 'backOut'
                  }).call(function () {
                  ...
                  _context6.next = 22;
                  return this.wait(0.95);
                case 22:
                  this.progressLabel.string = this.cells.length + " / " + this.cells.length;
                  this.status.string = '完成：从脚拼起，最终变成可爱小动物';
                  this.showResult('success', '完成！', '兔兔完成');
                  this.setAutomationStatus('passed');
                  this.updateControlButtons();
                case 27:
                case "end":
            ...
            return _regeneratorRuntime().wrap(function _callee6$(_context7) {
              while (1) switch (_context7.prev = _context7.next) {
                ...
                case 2:
                  ...
                  this.status.string = "\u989C\u6599\u4F4D\u5DF2\u88AB\u7B49\u5F85\u989C\u8272\u5360\u6EE1\uFF1B\u5F53\u524D\u5C42\u9700\u8981 " + needed;
                  this.progressLabel.string = '×';
                  this.setAutomationStatus('failed');
                  this.playSound('fail', 0.52);
                  this.showResult('fail', '颜料位已满', "\u9700\u8981 " + needed);
        ...
        _proto.resetSample = function resetSample() {
          ...
          this.updateSlotLabels();
          this.updateBlueprintPreview();
          this.status.string = '选择颜料罐，方块会自动寻找当前可拼的同色位置';
          this.setAutomationStatus('ready');
          this.updateControlButtons();
        };
        ...
        _proto.updateBlueprintPreview = function updateBlueprintPreview() {
          ...
          this.cells.forEach(function (cell) {
            ...
            opacity.opacity = cell.completed ? 0 : cell.row === currentRow ? 255 : 150;
            cell.ghost.setScale(cell.completed ? Vec3.ONE : cell.row === currentRow ? new Vec3(1.08, 1.08, 1) : Vec3.ONE);
          });
          var completedCount = this.cells.filter(function (cell) {
            return cell.completed;
          }).length;
          this.progressLabel.string = completedCount + " / " + this.cells.length;
        ...
        _proto.createTargetSquare = function createTargetSquare(parent, name, x, y, size, targetColor, targetEdge) {
          var node = new Node(name);
          node.layer = Layers.Enum.UI_2D;
          node.setPosition(x, y, 0);
          parent.addChild(node);
          ...
          // 未填区域始终是“空槽”：白色内芯 + 目标色边框与色点；绝不画成实心色块。
          graphics.fillColor = new Color(255, 255, 255, 238);
          graphics.roundRect(-size / 2, -size / 2, size, size, size * 0.24);
          graphics.fill();
          graphics.lineWidth = Math.max(1.25, size * 0.12);
          graphics.strokeColor = new Color(targetEdge.r, targetEdge.g, targetEdge.b, 255);
          graphics.roundRect(-size / 2 + 0.8, -size / 2 + 0.8, size - 1.6, size - 1.6, size * 0.2);
          graphics.stroke();
          graphics.fillColor = new Color(targetColor.r, targetColor.g, targetColor.b, 255);
          graphics.circle(0, 0, Math.max(1.6, size * 0.18));
          graphics.fill();
        ...
        _proto.celebrateLayer = /*#__PURE__*/function () {
          var _celebrateLayer = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(row) {
            var _this16 = this;
            var rowCells, rowCenterY, _loop4, index;
            return _regeneratorRuntime().wrap(function _callee7$(_context9) {
              while (1) switch (_context9.prev = _context9.next) {
                case 0:
                  this.playSound('layer', 0.32);
                  this.status.string = "\u7B2C " + (row + 1) + " \u5C42\u5B8C\u6210\uFF0C\u65B0\u4E00\u5C42\u5DF2\u7ECF\u5F00\u653E";
                  rowCells = this.cells.filter(function (cell) {
                    return cell.row === row;
                  });
                  rowCells.forEach(function (cell, index) {
                    tween(cell.fill).delay(index * 0.018).to(0.08, {
                      scale: new Vec3(1.12, 0.9, 1)
                    }, {
                      easing: 'quadOut'
                    }).to(0.1, {
                      scale: Vec3.ONE
                ...
                case 8:
                  ...
                  return _context9.delegateYield(_loop4(), "t0", 10);
                case 10:
                  index += 1;
                  _context9.next = 8;
                  break;
        ...
        _proto.undoLastMove = function undoLastMove() {
          ...
          this.cells.forEach(function (cell, index) {
            ...
            cell.fill.active = cell.completed;
            cell.fill.setScale(Vec3.ONE);
          });
          this.activeSlots = Array(5).fill(null);
        ...
        _proto.showResult = function showResult(kind, title, detail) {
          ...
          this.resultTitle.color = kind === 'success' ? new Color(89, 70, 154, 255) : new Color(174, 75, 83, 255);
        ...
        _proto.createControlButton = function createControlButton(name, text, x, y) {
          var node = this.addOutlinedPanel(this.canvasNode, name, x, y, 44, 38, 19, new Color(255, 252, 246, 248), new Color(219, 202, 232, 255), 2, false);
          this.addLabel(node, text, 0, 0, 11, new Color(88, 82, 108, 255), 40, true);
          var button = node.addComponent(Button);
          var opacity = node.addComponent(UIOpacity);
          return {
            node: node,
        ...
        _proto.setAutomationStatus = function setAutomationStatus(status) {
          if (typeof document !== 'undefined') {
            document.documentElement.dataset.t1Status = status;
            document.documentElement.dataset.renderMode = 'paint-block-build';
            ...
            document.documentElement.dataset.uiVersion = 'paint-queue-board-v5-readable';
            ...
            document.documentElement.dataset.blockStyle = 'hollow-targets-solid-completed-blocks';
